...
r_func_path <- "./_func"
r_funcs <- c("libraries.Rmd", "common.Rmd", "netcdf.Rmd")
```
...
#rsc_dir <- "/scratch/data/aiqc/htmlreport/nrt_bo/nrt_bo/resources"
...
A single [Parquet](https://parquet.apache.org/) file has been created from over 750 NetCDF files from Baltic Sea NRT in situ observations.
...
### Pre-processed files
  ...
  - **Header information**: [netcdf_nrt_bo_header.yaml](./resources/netcdf_nrt_bo_header.yaml)
  - **BO data**: [netcdf_nrt_bo.parquet](./resources/netcdf_nrt_bo.parquet)
...
kbl(summary_table, caption = "Variable names and data types") %>% 
  kable_styling(bootstrap_options = c("striped", "hover",
                                      "condensed", "responsive"))
```

<div class="warning" style='padding:1em; background-color:#E9D8FD; color:#69337A'>
<span>
<p style='text-align:center'>
<b>Missing `pres`</b></p>
<p>

Values were generated from the 'deph' column when NetCDF files lacked this column. The 'p_from_z' function from the
 <a href="https://www.teos-10.org/">Thermodynamic Equation of Seawater 2010 (TEOS-10)</a>
was used for the conversion with the following arguments.

<ul>
  <li><b>z</b>: deph</li>
  <li><b>lat</b>: latitude</li>
  <li><b>geo_strf_dyn_heigh</b>: None</li>
  <li><b>sea_surface_geopotential</b>: None</li>
</ul>
...
### Number of profiles {.tabset .tabset-pills }
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10}
p_year_month_hist <- create_sample_time_hist(df_year_month, "Year-month") +
  scale_x_discrete(
    labels = function(x) {
      years <- as.numeric(substr(x, 1, 4))
      months <- substr(x, 6, 7)
      ifelse(years %% 5 == 0 & months == "01", substr(x, 1, 4), "")
    }
  )

print(p_year_month_hist)
```

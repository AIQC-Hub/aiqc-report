...
summarise_df_dup_within <- function(df_orig, df_dup) {
  summarise_df_dup_within_common(df_orig, df_dup, precise_longitude, precise_latitude)
}

summarise_df_dup_across <- function(df_orig, df_dup) {
  summarise_df_dup_across_common(df_orig, df_dup, precise_longitude, precise_latitude)
}
